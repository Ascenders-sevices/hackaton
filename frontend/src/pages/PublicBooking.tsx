      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
            <div className="space-y-4 rounded-3xl border bg-background/90 p-6 shadow-sm backdrop-blur">
                ...
                <div className="space-y-2 xl:col-span-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      placeholder="for example insaf-property"
                    />
            ...
            {propertyData ? (
              <div className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
                <div className="space-y-4">
                  <Card className="rounded-3xl border bg-background/90 shadow-sm">
                    <CardHeader>
                      ...
                      <CardDescription>
                        {propertyData.search.nights > 0
                          ? `${propertyData.rooms.length} room(s) available for ${propertyData.search.nights} night(s).`
                ...
                <div className="space-y-4">
                    ...
                    <CardContent className="space-y-3 text-sm">
                      ...
                      {propertyData.property.contact_email ? (
                        <div className="flex items-center gap-3">
                          ...
                          <span>{propertyData.property.contact_email}</span>
                        </div>
                      ) : null}
                  ...
                  {confirmation ? (
                    <Card className="rounded-3xl border border-emerald-200 bg-emerald-50/80 shadow-sm dark:border-emerald-900 dark:bg-emerald-950/30">
                      <CardHeader>
